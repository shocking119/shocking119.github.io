...
下面的内容也可以参考我以前的博文 [JavaScript 中的 this](https://utachi.cn/2015/06/12/JavaScript-this/)
...
详情见以前的博文 [JavaScript 函数 -bind 与 currying](https://utachi.cn/2015/06/11/JavaScript-function/#bind--currying)。
